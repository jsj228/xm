...
class BuilderConfig extends Admin
{
	private $_title;
	private $_suggest;
	...
	public function groupLocalComment($group_name, $mod)
	{
		...
		$this->keyRadio($mod . '_LOCAL_COMMENT_CAN_GUEST', lang('_COMMENTS_ALLOW_VISITOR_IF_'), lang('_ALLOW_DEFAULT_'), array(lang('_DISALLOW_'), lang('_ALLOW_')))->keyRadio($mod . '_LOCAL_COMMENT_ORDER', lang('_COMMENTS_SORT_'), lang('_DESC_DEFAULT_'), array(lang('_DESC_'), lang('_ASC_')))->keyText($mod . '_LOCAL_COMMENT_COUNT', lang('_COMMENTS_PAGE_DISPLAY_COUNT_'), lang('_COMMENTS_PAGE_DISPLAY_COUNT_DESC'));
