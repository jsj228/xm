...
AJAX = {
    ...
    alert: function(){
        ...
        $.getJSON('/ajax/profit/alert',function(d){
            if(!d.status){
                if(!$.cookie('alertmana')){
                    $('body').append('<div class="mana-adv mana-adv-up" style="padding:15px;"><p style="font-family:\'hiragino sans gb\';height:40px;line-height: 30px;">邀请用户赚佣金 <img onclick="hidemana(this);$.cookie(\'alertmana\',1,{expires:7});"  style="float:right;cursor:pointer;" src="/images/jubi/x.png" alt=""/> </p> <p style="font-size:14px;color:#777;">推荐香港比特国际给他人即可获得被推荐人及其下家的部分交易手续费作为佣金</p> <a class="common-button" style="padding:8px 20px;border-radius:30px;display: inline-block;margin-left:65px;margin-top:15px;" href="/ajax/profit/activity">马上邀请</a> </div>');}
            }else{
    ...
    alertbtc:function(flag){
        if(!$.cookie('alertbtccookie') || flag){
            ...
            warinhtml += '<div class="dialog-step-1">为了给用户提供更优质的服务， <em style="color:#e55600;font-style:normal;">自7月1日起</em>，香港比特国际网比特币（BTC）交易业务将全部转至比特币第一交易所，该平台免收BTC交易手续费并拥有更活跃的市场，香港比特国际网将不再提供比特币买卖、转入服务，若给您带来不便敬请谅解。您可以点击下面按钮将BTC一键转存至比特币交易网。<p  style=" margin: 10px 0; ">若您有挂单冻结的比特币资产，请先撤销挂单后再进行转出操作。 <a style="  color: #e55600;text-decoration: underline;" href="/finance/trades.html">立即去撤单</a></p><p>请您于 <em style="color:#e55600;font-style:normal;">7月15日24：00</em>之前完成BTC的转出操作，衷心感谢您的理解与支持。</p>';
            ...
            warinthree += '<div style="text-align:center;padding:35px;font-size:16px;"><div style="font-size:20px;color:#690;"><i style="vertical-align: middle;" class="fa fa-2x fa-check"></i> 创建成功</div>你在比特币第一交易所的账号为 <span style="color:#e55600;"> '+USER[1]+'</span><div>登录密码，交易密码与香港比特国际网相同</div></span>   ';
            warinthree += '<div style="text-align:center;margin:20px 0 20px 0;"><a onclick="AJAX.sync_btc()" class="button button-size1 button-radius">立即转入比特币第一交易所账户</a></div>';
            warinthree += '</div>';
            warinthree += '</div>';
    ...
    alertdrk: function () {
        if(!$.cookie('alertbtccookie')) {
            ...
            warinhtml += '<div class="ui-dialog-title" onselectstart="return false">';
            warinhtml += '<span class="dialog-step-1" style="color: #ffffff">尊敬的宝贝币网用户:</span><span class="dialog-step-2">转出达世币</span>';
            warinhtml += '<a class="ui-dialog-closebutton" onclick="lcookie()">&times;</a>';
            warinhtml += '</div>';
            warinhtml += '<div class="ui-dialog-content">';
            warinhtml += '<div class="dialog-step-1">您好！由于香港比特国际网达世币长期交易量过低，平台基于对资产安全和用户体验考虑，计划于 <em style="color:#e55600;font-style:normal;">2018年9月17日</em>下线达世币，请相关用户妥善处理在平台的达世币资产。<p  style=" margin: 10px 0; ">若您有挂单冻结的达世币资产，请先撤销挂单后再进行转出操作。 <a style="  color: #e55600;text-decoration: underline;" onclick="lcookie()" href="/finance/trades.html?coin=drk">立即去撤单</a></p><p>请您于 <em style="color:#e55600;font-style:normal;">9月17日24：00</em>之前完成DRK的转出操作，衷心感谢您的理解与支持。</p>';
    ...
    check:function(){
        $.getJSON('/ajax/user/check',function(d){
            ...
            if(d.status){
                $('#accountmsg').html('您还没有比特币第一交易所账户，可一键创建比特币第一交易所账户');
                $('#tradeacc').html('创建比特币第一交易所账户');
            ...
            // 已经有账户
                ...
                $('#accountmsg').html('您在比特币第一交易所账号为: <em style="font-style: normal;color:#e55600;">'+USER[1]+'</em><br> 您可一键转入比特币第一交易所账户进行交易');
                $('#tradeacc').on('click', function () {
                    AJAX.sync_btc();
                })
            }
...
$(function(){
    ...
    if(os.isPc){
        $('body').append('<div class="sidetool hidden-xs"><ul><li><a href="http://wpa.b.qq.com/cgi/wpa.php?ln=1&key=XzkzODAyNDczN18xNjMyMjVfNDAwNjU3ODg4MF8yXw" target="_blank"><i class="sidetool-item qq"></i></a><span style="cursor:pointer;" onclick="window.open(\'http://wpa.b.qq.com/cgi/wpa.php?ln=1&key=XzkzODAyNDczN18xNjMyMjVfNDAwNjU3ODg4MF8yXw\')">QQ在线客服</span></li><li><a href=""><i class="sidetool-item wechat"></i></a><span class="sqrcode"><img src="/images/jubi/wx-qrcode.png" alt=""><i>宝贝币网微信公众号</i></span></li><li><a href=""><i class="sidetool-item mobile"></i></a><span class="sqrcode"><img width="100" style="background-color: #fff;" src="/images/jubi/jubi-app.png" alt=""><i>宝贝币网手机APP下载</i></li><li><a href=""><i class="sidetool-item tel"></i></a><span>400-657-8880</span></li></ul></div>');
    }
    $('.footer_bottom').prepend('<div class="autobox"><span style="display: inline-block;color:#a6a9ab;">CopyRight© 2013-2016宝贝币网All Rights Reserved. Powered by亿贝宝（惠州）科技有限公司 | 工商注册号：110105016727871 &nbsp;&nbsp;|&nbsp;&nbsp;<a href="http://www.miitbeian.gov.cn/publish/query/indexFirst.action" target="_blank">京ICP备14009321号</a><br/>京公网安备11010802018020号  | 地址：北京市海淀区人大北路33号大行基业大厦1411｜<a href="/">jubi.com</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="/about/join.html">加入我们</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="/help/api.html">API</a></span> <span style="display: inline-block; color:#a6a9ab"></span><a style="float:right;margin-top:5px;" id=\'___szfw_logo___\' href=\'https://credit.szfw.org/CX20151225013017170181.html\' target=\'_blank\'> <img src=\'http://icon.szfw.org/cert.png\' style="vertical-align:middle;" height="29" border=\'0\' /></a><script type="text/javascript">(function(){document.getElementById("___szfw_logo___").oncontextmenu = function(){return false;}})();</script></div>')
    //底部替换
...
function vip_ds(){
    ...
    html +=    '<p>您好！</p>'
    html +=        ' <p>首先感谢您对宝贝币网的长期支持！根据您在宝贝币网充值、交易的状况及活跃程度，祝贺您升级为宝贝币网VIP用户！</p>'
    html +=       ' <p>您的宝贝币网账号将增加<img height="15" style="vertical-align:text-top;margin:0 3px;" src="/images/jubi/vip.png" alt=""/>标识，同时您将享受到以下所有VIP待遇：</p>'
    html +=       ' <ol>'
    html +=            '<li>交易手续费为 <em>0.8‰</em>。</li>'
    html +=            '<li>VIP用户的提现申请将被<em>优先受理</em>。</li>'
    html +=           ' <li>申请成为经理人，邀请新用户可享受<em>35%</em>的交易手续费返佣。</li>'
    html +=            '<li>能<em>优先</em>参与宝贝币网各类活动、评测体验宝贝币网新产品。</li>'
    html +=            '<li>VIP用户在比特币交易网（www.btctrade.com）也有账户，经申请能升级成为<em>比特币交易网VIP用户</em>。（注册邮箱、绑定手机、实名认证信息，这三项信息有一项与宝贝币网账号相同即可）</li>'
    html +=            '<li>VIP用户享有与宝贝币网相关合作在同等条件下的 <em> 优先权</em>。</li>'
    html +=       '</ol>'
    html +=       ' <p style="margin-top:20px;font-size:13px;color:#666;">感谢您一直以来对宝贝币网的支持，我们会用优质与专业的服务回馈您对我们的信任。如有疑问请随时咨询客服，电话：400-657-8880</p>'
    html +=   '</div>'
    html += '</div>'
