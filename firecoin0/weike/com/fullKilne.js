...
/* 		util.globalurl.isremote ? (t = util.globalurl.depth, $.get(t, function(t) {
	...
	Bt._future_btc_market_num = new Array("0", "-1", "-1", "-1", "-1"), Bt._future_ltc_market_num = new Array("1", "-1", "-1", "-1", "-1"), Bt.PushNameVar = {}, Bt.PushNameCon = ["spot", "this_week", "next_week", "month", "quarter"], Bt.strMarket = {
		...
		if (null != t && t.bweike && t.sweike && "" != t.bweike && "" != t.sweike) {
			var e = this._depthData;
			e.array = [];
			for (var r = 0; r < t.bweike.length; r++) {
				var a = {};
				
				a.rate = t.bweike[r][0], a.amount = t.bweike[r][1], e.array.push(a)
			}
			for (var r = 0; r < t.sweike.length; r++) {
				var a = {};
				a.rate = t.sweike[r][0], a.amount = t.sweike[r][1], e.array.push(a)
			}
			e.asks_count = t.bweike.length, e.bids_count = t.sweike.length, e.asks_si = e.asks_count - 1, e.asks_ei = 0, e.bids_si = e.asks_count, e.bids_ei = e.asks_count + e.bids_count - 1;
