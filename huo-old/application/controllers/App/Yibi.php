...
class App_YibiController extends App_BaseController
{
    ...
    protected $dobi_used_key = "EIML%CcrtqVwXzrT4s8%F5YaDdZ1F^6A";//多比传给法币
    protected $fabi_used_key = "1P069*oUQO7*KWN@PXh7X!NP%c6#hjd7";//法币传给多比
...
//        var_dump($yibichange);die;
    ...
    //向易币发起内转
    public function dobiturnyibi($email,$area, $mo, $coin,$number, $txid ,$type=1)//$type=1 从易币转出到多比 $type=2 从多比转到易币
    {
